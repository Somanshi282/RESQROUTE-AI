  ...
  return (
    <View style={styles.tabItem}>
      <View style={[styles.tabIconWrap, focused && styles.tabIconActive]}>
        <Feather name={name as any} size={18} color={focused ? colors.primary : colors.textMuted} />
      </View>
...
export default function UserLayout() {
  return (
    <Tabs screenOptions={{
      ...
      <Tabs.Screen name="nearby" options={{ tabBarIcon: ({ focused }) => <TabIcon name="radio" label="NEARBY" focused={focused} /> }} />
...
const styles = StyleSheet.create({
  ...
  tabIconActive: { backgroundColor: colors.primaryDim },
